...
%%
%% PJC
%% based on original: https://github.com/novoid/LaTeX-KOMA-template 
...
\newcommand{\mytitlepage}{template/title_ABSA}
...
%% To include the todos leave this blank or other todonotes package options
%% see todonotes package options in docs
%% see below also for the setting of myaddlistoftodos boolean, true if want
%% todos included as part of table of contents
...
\graphicxForceDraftEqualFalse{true}
%% if true graphicx ignores global draft option and forces draft=false
%% if false does nothing, inherits from global document class option
...
% see tips-tricks.pdf should be loaded nearly last to ensure you get appropriate behaviour in
% in all the packages that cleveref has to alter
% have all the usual ref just with cin front cref,
\usepackage{cleveref}
