...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%
%%%  set document class to KOMA-script `scrbook`
%%%  use variables set in main.tex
%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% \documentclass[<global options>]{<class>}
% The options in the <global options> list will be tried by the class and any package loaded in the preamble, 
% but won't show errors or warnings if not known by a package.
...
%
%DIV is the proportions to break page into: 9-> big margins, 14-> normal margins, 16 -> very narrow
%DIV=calc,           %% calculates a good DIV value for type area; 66 characters/line is great
DIV=14,              %% reducing margins for single page
                     %% page layout options for KOMA see sec 2.6
%                     
BCOR=\myBCOR,        %% binding correction, adds extra space to allow for binding 
					 %% not needed unless binding a book 
%
headinclude=true,    %% is header part of margin space or part of page content?
footinclude=false,   %% is footer part of margin space or part of page content?
%
open=any,            %% "any", "right" or "left": start new chapter on any or right or left page
                     %% has no impact in single sided \mylaterality=single because LHS, RHS not distinguished
					 %% see sec 3.16, Structuring of Documents
%
appendixprefix=true, %% adds appendix prefix; only for book-classes with \backmatter
%
bibliography=totoc,  %% adds the bibliography to table of contents (without number)
					 %% see sec 3.23 Bibliography
% useful to have draft for everything except pics and charts
%   ref: https://tex.stackexchange.com/questions/49277/what-does-the-draft-mode-change/49283#49283
%   ref: https://tex.stackexchange.com/questions/95334/how-can-i-set-the-final-option-for-the-graphicx-package-in-xetex
% normally this class draft pushed to all packages loaded subsequently, need to override draft for
% graphicxs when it is loaded, (with final=true)
draft=\mydraft,      %% if true: included graphics are omitted and black boxes
                     %%          mark overfull boxes in margin space
                     %% see secs 3.3,  4.5 Draft Mode
%                     
...
%doc%
%PJC% replaced obsolete scrlayer2 with scrlayer-scrpage as per scrpage2 warning
\usepackage{scrlayer-scrpage} %%  advanced page style using KOMA
%%% PJC remove this
%\usepackage[DIV=14,BCOR=0,headinclude=true,footinclude=true]{typearea}
\ifoot[]{HSE: does this work in draft}
\cfoot[]{}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% use mathtools
%   ref: https://mirror.hmc.edu/ctan/macros/latex/contrib/mathtools/mathtools.pdf
%
% The mathtools package is an extension package to amsmath. There are two things
% on mathtools’ agenda: (1) correct various bugs/defeciencies in amsmath until
% these are fixed by the AMS and (2) provide useful tools for mathematical typesetting,
% be it a small macro for typesetting a prescript or an underbracket, or entirely
% new display math constructs such as a multlined environment.
\usepackage{amsmath}    % mathtools will load it anyway as its a dependency for mathtools
